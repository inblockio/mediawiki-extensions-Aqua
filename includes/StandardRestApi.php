...
class StandardRestApi extends SimpleHandler {
    ...
    private const VALID_ACTIONS = ['help', 'verify_page', 'get_page_by_rev_id', 'page_all_rev', 'get_page_last_rev', 'page_last_rev_sig', 'get_page_all_rev_sig', 'get_witness_data', 'request_merkle_proof', 'store_signed_tx', 'store_witness_tx', 'request_hash' ];
