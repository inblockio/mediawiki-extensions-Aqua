...
/**
 * @covers \DataAccounting\Verification\Hasher
 */
class HashingServiceTest extends TestCase {
	...
	public function setUp(): void {
		...
		$this->expectedWitnessHash = '694f2d4e2eafaa1372817ae377f04996352fee2a573377af25069dd9a24463f217f8d8d787bdb6357a858e42a6180c832868b6aeaa237102b3a303e0f86617fb';
	}

	public function testCalculateContentHash(): void {
		$this->assertEquals(
			$this->expectedContentHash,
			$this->verificationEngine->getHasher()->getHashSum( $this->content )
		);
	}
	...
	public function testCalculateMetadataHash(): void {
		...
		$metadataHash = $this->verificationEngine->getHasher()->getHashSum( $this->domainId . $timestamp . $prevVH );
		$this->assertEquals(
	...
	public function testCalculateWitnessHash(): void {
		$domain_snapshot_genesis_hash = '9df4198c20d31bb46f8ea97417346108b01ca13af20902e1755a1aad5bc3ba689f3731f653b4daa67ef657b96915fd7ac1035ab93938d9afde9c4c13cfd468c7';
	...
	public function testCalculateVerificationHash(): void {
		...
		$VH = $this->verificationEngine->getHasher()->getHashSum(
			$this->expectedContentHash .
			$this->expectedMetadataHash .
			$this->expectedSignatureHash
		);
